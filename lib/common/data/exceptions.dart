...
class GeneralTextException extends Failure {
  final String textCode;

  const GeneralTextException({
    required this.textCode,
  });

  @override
  String get message => textCode;
}
  ...
  String get message {
    switch (code) {
      ...
      case 'invalid-credential':
        return 'Credenciais invalidas!. Verifique se seu email e senha estão corretos';
